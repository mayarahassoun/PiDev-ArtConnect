...
import static controllers.DisplayEvent.latitude;
import static controllers.DisplayEvent.longitude;
...
public class EventMangement {
    ...
    void ajouterEvent(ActionEvent event) {
        ...
        event1.setLatitude(latitude);
        event1.setLongitude(longitude);
    ...
    public void openmap(ActionEvent actionEvent)  throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader((Main.class.getResource("/fxml/webview.fxml")));
