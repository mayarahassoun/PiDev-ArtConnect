...
public class DisplayReservation {
    ...
    void afficherReservationAccepter(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/fxml/ReservationAccepter.fxml"));
        try {
    ...
    void afficherReservationRefuser(ActionEvent event)
    {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/fxml/AfficherReservations.fxml"));
        try {
            ideventSel.getScene().setRoot(fxmlLoader.load());
        } catch (IOException e) {
            throw new RuntimeException(e);
    ...
    void menu(ActionEvent event) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/fxml/dashbord.fxml"));
        try {
            ideventSel.getScene().setRoot(fxmlLoader.load());
        } catch (IOException e) {
            throw new RuntimeException(e);
