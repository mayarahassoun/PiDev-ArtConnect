...
public class AcceuilController implements Initializable {
    ...
    public void openModifInterface3(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/pi_salma/Admin.fxml"));
    ...
    public void openModifInterface2(ActionEvent event) {
        try {
            // Load the Modif.fxml file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/pi_salma/User.fxml"));
            Parent root = loader.load();
