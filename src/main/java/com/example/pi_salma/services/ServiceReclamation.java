...
import com.example.pi_salma.interfaces.IReclamation;
...
public class ServiceReclamation  implements IReclamation {
  ...
  private void sendEmail(String to, String subject, String body) {
    ...
    public List<Reclamation> afficherReclamationsParUser() {
        ...
        String req = "SELECT r.* FROM reclamation r INNER JOIN user u ON r.id_user = u.Id WHERE u.Id LIKE  ?";
        try {
            PreparedStatement st = connection.prepareStatement(req);
