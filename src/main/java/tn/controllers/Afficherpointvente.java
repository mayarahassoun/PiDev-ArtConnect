...
public class Afficherpointvente {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        edtIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            try {
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/modifierpointvente.fxml"));
    ...
    void goToAddPointvente(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ajoutpointvente.fxml"));
            Parent root = loader.load();
            table.getScene().setRoot(root);
        } catch (Exception ex) {
            ex.printStackTrace();
