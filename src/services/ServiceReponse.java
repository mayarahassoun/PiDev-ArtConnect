...
public class ServiceReponse implements IReponse<Reponse> {
    ...
    public ServiceReponse() {
        ...
        private String getUserEmail(int id_reclamation) {
            ...
            String req = "SELECT email FROM users WHERE id_reclamation = ?";
            try {
                PreparedStatement st = connection.prepareStatement(req);
        ...
        @Override
            ...
            String req = "SELECT us.firstname, u.type, r.*, u.statut FROM reponse r LEFT JOIN reclamation u ON r.id_reclamation = u.id_reclamation LEFT JOIN users us ON u.id_user = us.id";
