...
public class ResServices {
    ...
    public void addReservation(Reservations r) {
        ...
        try {
            ...
            PreparedStatement selectEventStatement = cnx.prepareStatement(selectEventQuery);
...
//        }
    ...
    public void modifierEtatReservation(int idReservation, String nouvelEtat) {
        ...
        try {
            ...
            PreparedStatement statement = cnx.prepareStatement(reqModification);
    ...
    public void deleteReservation(int reservationId) {
        try {
            ...
            PreparedStatement deleteReservationStatement = cnx.prepareStatement(deleteReservationQuery);
